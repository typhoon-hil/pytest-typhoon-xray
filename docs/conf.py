# -*- coding: utf-8 -*-
#
# pytest-tytest documentation build configuration file, created by
...
project = u'pytest-tytest'
copyright = u'2015, Branko Milosavljevic'
author = u'Branko Milosavljevic'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-tytest Documentation',
     [author], 1)
]
